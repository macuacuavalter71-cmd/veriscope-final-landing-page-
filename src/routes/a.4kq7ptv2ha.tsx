...
export const Route = createFileRoute("/a/4kq7ptv2ha")({
  head: () => ({
    meta: [
      { title: "Acesso — Veriscope Edge | Veriscope" },
      { name: "description", content: "Área de acesso privada aos materiais adquiridos." },
      { name: "robots", content: "noindex, nofollow" },
      { property: "og:title", content: "Acesso — Veriscope Edge" },
...
function Page() {
  return (
    <DeliveryPage
      title="Veriscope Edge"
      requiredProducts={["edge"]}
      items={["edge"]}
    />
  );
}
